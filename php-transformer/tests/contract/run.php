...
$assert(str_contains($inlineSvgMarkup, 'class="wp-block-image album-art"'), 'passive meaningful inline SVG artwork preserves source class on the image block wrapper');
