...
$assertTrue(in_array('blocks-engine/author-layout', $columnsNames, true) && ! in_array('core/columns', $columnsNames, true), 'K4: Flex hero candidate preserves section topology without Group layout defaults.');
