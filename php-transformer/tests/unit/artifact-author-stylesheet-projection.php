...
$assert(preg_match('/<div class="stage-copy blocks-engine-source-div-[a-f0-9]+-\d+">Build source<p class="blocks-engine-source-p-[a-f0-9]+-\d+">Maintenance detail<\/p><ul class="chips"><li class="blocks-engine-source-li-[a-f0-9]+-\d+">HTML<\/li><\/ul><ul class="check-list"><li class="blocks-engine-source-li-[a-f0-9]+-\d+">Verified delivery<\/li><\/ul><\/div>/', $outerContent) === 1, 'structural list fallback retains source-tag provenance and nested topology for projected author CSS');
