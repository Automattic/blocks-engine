...
$beforeFamilies = array(
    ...
    'list-navigation alignment' => '.wp-block-navigation.blocks-engine-list-navigation:not(.blocks-engine-native-responsive-navigation){display:block;align-items:normal}',
    'list-navigation base' => '.wp-block-navigation.blocks-engine-list-navigation:not(.blocks-engine-native-responsive-navigation) .wp-block-navigation-item.wp-block-navigation-link{display:list-item;font:inherit}',
    'list-navigation container layout' => '.wp-block-navigation.blocks-engine-list-navigation:not(.blocks-engine-native-responsive-navigation) .wp-block-navigation__container{display:contents;list-style:none}',
