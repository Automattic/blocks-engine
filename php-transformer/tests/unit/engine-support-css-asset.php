...
$assert(
    '@layercontract;.contract-author-only{color:#123456}.desktop-nava{color:#fff}.btn{display:inline-flex;padding:1rem;background:#123456;width:100%}@media(max-width:700px){.desktop-nav{display:none}.mobile-nav{background:rgba(0,0,0,.9)}}' === $normalizedAuthorCss,
