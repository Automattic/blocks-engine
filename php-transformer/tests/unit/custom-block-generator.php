...
$assert(str_ends_with((string) ($branchBlock['blockName'] ?? ''), '/layout-shell') && array('div', 'div', 'section') === array_column($branchBlock['attrs']['wrappers'] ?? array(), 'tagName') && array('core/paragraph', 'core/paragraph') === array_column($branchBlock['innerBlocks'] ?? array(), 'blockName'), '6: layout-shell folds a branching semantic section while exposing its ordered native children');
...
$assert(str_ends_with((string) ($twoWrapperBranchBlock['blockName'] ?? ''), '/layout-shell') && array('div', 'section') === array_column($twoWrapperBranchBlock['attrs']['wrappers'] ?? array(), 'tagName') && array('core/paragraph', 'core/paragraph') === array_column($twoWrapperBranchBlock['innerBlocks'] ?? array(), 'blockName'), '6: a generic wrapper and semantic section share one shell with direct native children');
