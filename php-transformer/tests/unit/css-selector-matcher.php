...
$assert($match('input:first-of-type', $byId('control'))['matches'], 'matches first-of-type independently of child position');
$assert(! $match('p:first-of-type', $byId('two'))['matches'], 'rejects a later sibling of the same type');
