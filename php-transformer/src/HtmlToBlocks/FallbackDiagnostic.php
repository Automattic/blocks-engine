...
final class FallbackDiagnostic
{
    ...
    private static function defaults(array $fields): array
    {
        ...
        return match ( $code ) {
            ...
            'html_legacy_frameset_navigation' => array(
                'severity'              => 'warning',
                'conversion_classification' => 'unsupported_loss',
                'loss_class'            => 'unsupported_legacy_navigation_loss',
                'diagnostic_class'      => 'unsupported_legacy_navigation',
                'preservation_strategy' => 'convert_noframes_fallback_content',
                'runtime_requirement'   => 'none',
                'recoverability'        => 'recoverable_with_manual_navigation_mapping',
                'actionability'         => 'map_legacy_frame_destinations_to_pages_or_navigation_blocks',
                'suggested_repair_class' => 'map_legacy_frameset_navigation',
                'suggested_primitive'   => 'navigation',
                'materialization_hint'  => 'convert_the_noframes_fallback_content_and_rebuild_frame_destinations_as_standard_navigation',
            ),
