...
final class FallbackDiagnostic
{
    ...
    private static function defaults(array $fields): array
    {
        ...
        return match ( $code ) {
            ...
            'html_list_item_block_grammar_fallback' => array(
                'severity'              => 'warning',
                'conversion_classification' => 'editable_approximation',
                'loss_class'            => 'native_block_gap_preserved',
                'diagnostic_class'      => 'block_grammar_preserved',
                'preservation_strategy' => 'sanitized_core_html',
                'runtime_requirement'   => 'none',
                'recoverability'        => 'recoverable_with_structural_list_component_mapping',
                'actionability'         => 'map_structural_list_items_to_an_editor_native_component',
                'suggested_repair_class' => 'map_structural_list_component',
                'suggested_primitive'   => 'core/html',
                'materialization_hint'  => 'preserve_the_coherent_list_until_an_editor_native_component_can_represent_block_level_item_content',
            ),
