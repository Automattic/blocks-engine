...
// the core/group tagName allowlist. Regenerate when the engine's WordPress
// block-library dependency changes:
//   node scripts/generate-block-attrs-snapshot.mjs
import { parse } from '@wordpress/block-serialization-default-parser';
import snapshot from './core-block-attrs.json' with { type: 'json' };
...
const SNAPSHOT = snapshot as BlockAttrsSnapshot;
...
const DEFAULT_ALLOWLIST = ['core/html'];
