...
function blocks_engine_figma_transformer_run_parser_parity_contract(callable $assert): void
{
    ...
    $assert('parity:mask-node' === ($transformDiagnostics['mask_effect_clipping']['suppressed_mask_source_nodes'][0]['node_id'] ?? null), 'parser-parity-suppressed-mask-source-node-sample');
