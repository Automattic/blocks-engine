...
function blocks_engine_figma_transformer_run_site_generation_quality_contract(callable $assert, callable $fileContent, callable $artifactQualitySignalCodes, callable $artifactQualitySignal): void
{
            ...
            array(
                ...
                'children' => array(
                    ...
                    array(
                        ...
                        'itemSpacing' => 24,
                        'children' => array(
                            array('id' => 'responsive-rows:price-a', 'type' => 'FRAME', 'name' => 'Price card', 'width' => 380, 'height' => 800, 'minHeight' => 800, 'layoutMode' => 'VERTICAL', 'children' => array(array('id' => 'responsive-rows:price-a-content', 'type' => 'FRAME', 'name' => 'Price content', 'width' => 280, 'height' => 64, 'layoutMode' => 'VERTICAL', 'children' => array(array('id' => 'responsive-rows:price-a-copy', 'type' => 'TEXT', 'name' => 'Price copy', 'characters' => 'A compact plan description', 'width' => 280, 'height' => 32))))),
    ...
    blocks_engine_figma_transformer_contract_assert_css_rule_contains($assert, $desktopOnlyResponsiveRowsMobileBlock, '.figma-node-responsive-rows-price-a-price-card', array('flex-shrink:0', 'flex-basis:auto', 'flex-grow:0'), 'desktop-only-responsive-stacked-card-restores-content-driven-column-flow');
    blocks_engine_figma_transformer_contract_assert_css_rule_contains($assert, $desktopOnlyResponsiveRowsMobileBlock, '.figma-node-responsive-rows-price-a-price-card', array('min-height:0'), 'desktop-only-responsive-stacked-flow-card-releases-desktop-height-floor');
