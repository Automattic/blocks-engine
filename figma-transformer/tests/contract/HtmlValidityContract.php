...
function blocks_engine_figma_transformer_run_html_validity_contract(callable $assert, callable $fileContent): void
{
    ...
    $assert(str_contains($html, 'class="figma-node-validity-measured-packed-nav-measured-main-nav-links" data-figma-node-id="validity:measured-packed-nav" data-figma-node-name="Measured Main Nav Links">News      About      Contact</'), 'html-validity-measured-packed-route-text-preserves-source-text');
