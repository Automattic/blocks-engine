...
require_once __DIR__ . '/LinkContract.php';
...
$assert(str_contains($fseFooterRowRule, 'width:100%') && ! str_contains($fseFooterRowRule, 'max-width:1440px') && str_contains($fseFooterRowRule, 'height:131px') && str_contains($fseFooterRowRule, 'position:relative') && str_contains($fseFooterRowRule, 'padding-right:clamp(24px,calc((100% - 1216px) / 2),112px)') && str_contains($fseFooterRowRule, 'padding-left:clamp(24px,calc((100% - 1216px) / 2),112px)'), 'fse-footer-row-relative');
...
blocks_engine_figma_transformer_run_link_contract($assert, $fileContent, $artifactQualitySignalCodes);
